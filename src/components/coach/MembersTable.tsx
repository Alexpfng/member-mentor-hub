              ...
              <tr key={r.memberId} style={{ borderBottom: "1px solid rgba(255,255,255,0.05)", cursor: "pointer" }}
                ...
                <td style={{ padding: "12px 12px", textAlign: "right" }} onClick={(e) => e.stopPropagation()}>
                  <div style={{ display: "flex", gap: 6, justifyContent: "flex-end" }}>
                    <button className="cst-btn cst-btn-ghost-dark cst-btn-sm" onClick={() => navigate({ to: "/coach/membre/$memberId/adapter", params: { memberId: r.memberId }, search: {} })}>ADAPTER S+1</button>
